...
public class FormApi {
	...
	public ResponseEntity<Void> delete2WithHttpInfo(String formKey) throws RestClientException {
		...
		if (formKey == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'formKey' when calling delete2");
		}
		...
		return apiClient.invokeAPI("/form/{formKey}", HttpMethod.DELETE, uriVariables, localVarQueryParams,
	...
	public ResponseEntity<List<Form>> find5WithHttpInfo() throws RestClientException {
		...
		return apiClient.invokeAPI("/form/", HttpMethod.GET, Collections.<String, Object>emptyMap(),
	...
	public ResponseEntity<Form> get4WithHttpInfo(String formKey) throws RestClientException {
		...
		if (formKey == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'formKey' when calling get4");
		}
		...
		return apiClient.invokeAPI("/form/{formKey}", HttpMethod.GET, uriVariables, localVarQueryParams,
				localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
				localVarContentType, localVarAuthNames, localReturnType);
	}
	...
	public ResponseEntity<Void> save3WithHttpInfo(Form form) throws RestClientException {
		...
		if (form == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'form' when calling save3");
		}
		...
		return apiClient.invokeAPI("/form/", HttpMethod.POST, Collections.<String, Object>emptyMap(),
				localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams,
				localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
	}
	...
	public ResponseEntity<Void> update2WithHttpInfo(String formKey, Form form) throws RestClientException {
		...
		if (formKey == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'formKey' when calling update2");
		}

		// verify the required parameter 'form' is set
		if (form == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'form' when calling update2");
		}
		...
		return apiClient.invokeAPI("/form/{formKey}", HttpMethod.PATCH, uriVariables, localVarQueryParams,
				localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
				localVarContentType, localVarAuthNames, localReturnType);
	}
}
