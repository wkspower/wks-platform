...
public class DeploymentControllerApi {
    ...
    public ResponseEntity<Void> deployWithHttpInfo(String body) throws RestClientException {
        ...
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling deploy");
        }
        ...
        return apiClient.invokeAPI("/deployment/", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
}
