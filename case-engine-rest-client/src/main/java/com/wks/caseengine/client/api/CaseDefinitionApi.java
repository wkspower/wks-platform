...
public class CaseDefinitionApi {
    ...
    public ResponseEntity<Void> delete4WithHttpInfo(String caseDefId) throws RestClientException {
        ...
        if (caseDefId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'caseDefId' when calling delete4");
        }
        ...
        return apiClient.invokeAPI("/case-definition/{caseDefId}", HttpMethod.DELETE, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<List<CaseDefinition>> find7WithHttpInfo(Boolean deployed) throws RestClientException {
        ...
        return apiClient.invokeAPI("/case-definition/", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<CaseDefinition> get6WithHttpInfo(String caseDefId) throws RestClientException {
        ...
        // verify the required parameter 'caseDefId' is set
        if (caseDefId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'caseDefId' when calling get6");
        }
        ...
        return apiClient.invokeAPI("/case-definition/{caseDefId}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<CaseDefinition> save5WithHttpInfo(CaseDefinition caseDefinition) throws RestClientException {
        ...
        if (caseDefinition == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'caseDefinition' when calling save5");
        }
        ...
        ParameterizedTypeReference<CaseDefinition> localReturnType = new ParameterizedTypeReference<CaseDefinition>() {};
        return apiClient.invokeAPI("/case-definition/", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CaseDefinition> update4WithHttpInfo(String caseDefId, CaseDefinition caseDefinition) throws RestClientException {
        Object localVarPostBody = caseDefinition;
        
        // verify the required parameter 'caseDefId' is set
        if (caseDefId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'caseDefId' when calling update4");
        }
        
        // verify the required parameter 'caseDefinition' is set
        if (caseDefinition == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'caseDefinition' when calling update4");
        }
        ...
        ParameterizedTypeReference<CaseDefinition> localReturnType = new ParameterizedTypeReference<CaseDefinition>() {};
        return apiClient.invokeAPI("/case-definition/{caseDefId}", HttpMethod.PATCH, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
}
