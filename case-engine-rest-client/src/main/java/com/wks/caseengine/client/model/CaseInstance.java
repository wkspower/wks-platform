...
import com.wks.caseengine.client.model.CaseAttribute;
 ...
 */
@JsonPropertyOrder({
  CaseInstance.JSON_PROPERTY_GET_ID,
  CaseInstance.JSON_PROPERTY_BUSINESS_KEY,
  CaseInstance.JSON_PROPERTY_CASE_DEFINITION_ID,
  CaseInstance.JSON_PROPERTY_STAGE,
  CaseInstance.JSON_PROPERTY_CASE_OWNER,
  CaseInstance.JSON_PROPERTY_CASE_OWNER_NAME,
  CaseInstance.JSON_PROPERTY_COMMENTS,
  CaseInstance.JSON_PROPERTY_DOCUMENTS,
  CaseInstance.JSON_PROPERTY_ATTRIBUTES,
  CaseInstance.JSON_PROPERTY_STATUS,
  CaseInstance.JSON_PROPERTY_ID
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.getId, caseInstance.getId) &&
        ...
        Objects.equals(this.status, caseInstance.status) &&
        Objects.equals(this.id, caseInstance.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(getId, businessKey, caseDefinitionId, stage, caseOwner, caseOwnerName, comments, documents, attributes, status, id);
  }
