...
public class DataExportControllerApi {
    ...
    public ResponseEntity<JsonObject> exportWithHttpInfo() throws RestClientException {
        ...
        return apiClient.invokeAPI("/export/", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
}
