...
public class JsonPrimitive {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(asBoolean, asDouble, asInt, asLong, asNumber, asCharacter, asBigDecimal, asBigInteger, asString, asFloat, Arrays.hashCode(asByte), asShort, _boolean, number, string, jsonArray, jsonObject, jsonPrimitive, asJsonNull, asJsonPrimitive, asJsonObject, asJsonArray, jsonNull);
  }
