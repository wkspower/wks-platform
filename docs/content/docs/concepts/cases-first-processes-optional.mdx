...
For a deeper Camunda-to-WKS concept map, see [Coming from Camunda](/docs/start/coming-from-camunda).
...
- [Coming from Camunda](/docs/start/coming-from-camunda) — the concept-by-concept map from BPMN-engine terms to WKS terms, with a worked Mapping Layer example.
