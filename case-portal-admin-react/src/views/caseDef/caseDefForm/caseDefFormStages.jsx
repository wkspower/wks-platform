...
export const CaseDefFormStages = ({ caseDef, setCaseDef }) => {
    ...
    const columns: GridColDef[] = [
        { field: 'index', headerName: 'Index', width: 100, sortable: false, editable: true, type: 'number' },
    ...
    const handleNewStage = () => {
        ...
        setCaseDef({
            ...
            stages: [
                ...caseDef.stages,
                { id: parseInt(lastStage.id) + 1, index: lastStage.index + 1, name: 'Stage ' + (parseInt(lastStage.id) + 1) }
            ]
        });
    };
