...
export const BpmEngineC8Form = ({ bpmEngine, setBpmEngine, open, handleClose }) => {
    ...
    const handleInputParamChange = (event) => {
        setBpmEngine({
            ...bpmEngine,
            parameters: { ...bpmEngine.parameters, [event.target.name]: event.target.value }
        });
    };
                    ...
                    <Grid item xs={12}>
                        <MainCard sx={{ p: 2 }} content={true}>
                            ...
                            <FormControl key="ctrlParamZeebeEndpoint" style={{ padding: '5px' }}>
                                ...
                                />
                                <FormHelperText id="paramZeebeEndpoint-helper-text">
                                    Zeebe Endpoint
                                </FormHelperText>
                            </FormControl>
                            <FormControl
                                key="ctrlParamZeebeEndpointPort"
                                style={{ padding: '5px' }}
                            >
                                <TextField
                                    ...
                                    onChange={handleInputParamChange}
                                />
                                <FormHelperText id="paramZeebeEndpointPort-helper-text">
                                    Zeebe Endpoint Port
                                </FormHelperText>
                            </FormControl>
                            <FormControl key="ctrlParamClientId" style={{ padding: '5px' }}>
                                <TextField
                                    ...
                                    onChange={handleInputParamChange}
                                />
                                <FormHelperText id="paramClientId-helper-text">
                                    Client Id
                                </FormHelperText>
                            </FormControl>
