 ...
 *   <li>{@link #TASK_COMPLETED} — user-task completion signal (e.g. BPMN {@code
 ...
 * Story 4.3 ({@code ExecutionSignalRouter}) is the enforcer; this enum only documents the ordering so
 ...
 * The split into {@link #TASK_STATUS_CHANGED} and {@link #TASK_COMPLETED} makes the type system
...
public enum ExecutionSignalKind {
   ...
   * #TASK_STATUS_CHANGED} so {@code MappingDiff} does not collapse the two shapes (Story 4.3.1 AC10).
   */
  TASK_COMPLETED,
