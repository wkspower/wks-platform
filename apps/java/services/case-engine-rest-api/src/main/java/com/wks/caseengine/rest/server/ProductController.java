...
public class ProductController {
	...
	@GetMapping(value = "/norm-parameters")
	 ...
	 * public ResponseEntity<ProductMonthWiseDataDTO>
	 * saveProductMonthWiseData(@RequestBody ProductMonthWiseDataDTO
	 * productMonthWiseDataDTO) {
	 * ProductMonthWiseDataDTO savedData =
	 * productService.saveMonthWiseData(productMonthWiseDataDTO);
