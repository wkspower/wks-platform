	...
	public	String getCosnumptionNormData(@RequestParam int year,@RequestParam UUID plantId,@RequestParam UUID siteId){	
		...
		System.out.println("obj "+obj);
		 return obj;
  			...
  			@PostMapping(value = "/saveBusinessDemand/{plantId}")
            public ResponseEntity<BusinessDemandDTO> saveShutdownData(@PathVariable UUID plantId, @RequestBody BusinessDemandDTO businessDemandDTO) {
                normParameterMonthlyTransactionService.saveBusinessDemandData(plantId,businessDemandDTO);
