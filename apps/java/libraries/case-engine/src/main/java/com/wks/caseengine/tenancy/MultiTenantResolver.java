...
/**
 * Multi-tenant strategy (default): resolve to the context tenant, else fail
 * closed.
 */
@Slf4j
@Component
@ConditionalOnProperty(name = "wks.tenancy.multi-tenant", havingValue = "true", matchIfMissing = true)
public class MultiTenantResolver implements TenantResolver {
	...
	public MultiTenantResolver(final SecurityContextTenantHolder holder,
