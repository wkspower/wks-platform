 ...
 */
@AllArgsConstructor
public class StartCaseEmailCmd implements Command<Void> {

	private CaseEmail caseEmail;

	@Override
	public Void execute(CommandContext commandContext) {
		commandContext.getProcessInstanceService().start(commandContext.getEmailToCaseProcess(), Optional.empty(),
				Optional.of(generateCaseEmailProcessVariable(commandContext, caseEmail)));
