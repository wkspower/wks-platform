...
public interface DecokingActivitiesNMDService {
	...
	public AOPMessageVM updateDecokingActivitiesIBRData( String year, String plantId, String reportType, List<CrackerConfigurationDTO> crackerConfigurationDTOList);
