...
public interface ExcelDataService {
    ...
    List<List<Object>> getReportForPlantProductionPlanData(String plantId, String year, String reportType, List<String> headers);

    List<List<Object>> getReportForPlantContributionYearWise(String plantId, String year, String reportType, List<String> headers);
