...
public class NormalOperationNormsServiceImpl implements NormalOperationNormsService{
	...
	public int calculateExpressionConsumptionNorms(String year,String plantId) {
		...
		return executeStoredProcedure(storedProcedure,plantId,site.getId().toString(), vertical.getId().toString(),year);
	}
	
	@Transactional
    public int executeStoredProcedure(String procedureName, String plantId, String siteId, String verticalId, String finYear) {
        try {
