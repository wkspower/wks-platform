...
import com.wks.caseengine.dto.tcs.CrudeBlendDTO;
import com.wks.caseengine.dto.tcs.CrudeBlendScreenDTO;
import com.wks.caseengine.dto.tcs.CrudeBlendWindowPostRequestDTO;
import com.wks.caseengine.dto.tcs.CrudeSpecificConstraintsDTO;
import com.wks.caseengine.dto.tcs.VGOVRDropDTO;
import com.wks.caseengine.repository.FinancialYearMonthRepository;
import com.wks.caseengine.repository.tcs.CrudeBlendWindowRepository;
...
public class CrudeBlendWindowService {
 ...
 public List<CrudeBlendScreenDTO> getCrudeBlendWindowData(String plantId, String siteId, String financialYear) {
      ...
      //  responseList.add(masterCrudeSpecificConstraintsDTO);
        ...
        List<com.wks.caseengine.dto.tcs.VGOVRDropDTO> vgovrDrop = crudeRepo.findVGOVRDropByPlant_FK_IdAndSite_FK_Id(java.util.UUID.fromString(plantId), java.util.UUID.fromString(siteId), financialYear).stream().map(proj -> {
            com.wks.caseengine.dto.tcs.VGOVRDropDTO dto = new com.wks.caseengine.dto.tcs.VGOVRDropDTO();
            dto.setId(proj.getId());
        ...
        MasterCrudeBlendDTO<com.wks.caseengine.dto.tcs.VGOVRDropDTO> masterVGOVRDropDTO = new MasterCrudeBlendDTO<>();
