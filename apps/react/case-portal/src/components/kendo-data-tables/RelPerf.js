...
export default function RelPerf() {
  ...
  const reliabilityPerformanceColumns = [
    ...
    { field: 'rationale', title: 'Rationale / Reasons for Changes', editable: true }
  ]
  const initialReliabilityRows = [
    { serialNumber: 1, parameter: 'Technical availability, YTD', uom: '%', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '>99%', rationale: '', id: 0 },
    // ...other rows as before...
  ]
  ...
  const [remarkDialogOpenReliability, setRemarkDialogOpenReliability] = useState(false)
  ...
  const initialFinancialRows = [
    { serialNumber: 1, parameter: 'Spares- Routine', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 0 },
    { serialNumber: 2, parameter: 'Spares- One Time', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 1 },
    { serialNumber: 3, parameter: 'Spares- Shutdown', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 2 },
    { serialNumber: 4, parameter: 'Services- Routine', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 3 },
    { serialNumber: 5, parameter: 'Services- One Time', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 4 },
    { serialNumber: 6, parameter: 'Services- Shutdown', uom: 'Rs/Cr', bestAchieved: '', fy25Aop: '', fy25Actual: '', fy26Plan: '', rationale: '', id: 5 }
  ]
  ...
  const [remarkDialogOpenFinancial, setRemarkDialogOpenFinancial] = useState(false)
  ...
  const majorIncidentsColumns = [
    { field: 'serialNumber', title: 'S.No.', widthT: 70, editable: false, type: 'number' },
    { field: 'incidentDescription', title: 'Incident Description', editable: true },
  ...
  const initialMajorIncidentsRows = [
    { serialNumber: 1, incidentDescription: '', rootCause: '', recommendation: '', targetDate: '', responsible: '', id: 0 },
    { serialNumber: 2, incidentDescription: '', rootCause: '', recommendation: '', targetDate: '', responsible: '', id: 1 }
  ]
  const [majorIncidentsRows, setMajorIncidentsRows] = useState(initialMajorIncidentsRows)
  const [modifiedMajorIncidentsCells, setModifiedMajorIncidentsCells] = useState({})
  const [remarkDialogOpenMajorIncidents, setRemarkDialogOpenMajorIncidents] = useState(false)
  const [currentRemarkMajorIncidents, setCurrentRemarkMajorIncidents] = useState('')
  const [currentRowIdMajorIncidents, setCurrentRowIdMajorIncidents] = useState(null)
  ...
  const initialReliabilityInitiativeRows = [
    { serialNumber: 1, initiative: '', outcome: '', recommendation: '', targetDate: '', responsible: '', id: 0 },
    { serialNumber: 2, initiative: '', outcome: '', recommendation: '', targetDate: '', responsible: '', id: 1 }
  ]
  const [reliabilityInitiativeRows, setReliabilityInitiativeRows] = useState(initialReliabilityInitiativeRows)
  const [modifiedReliabilityInitiativeCells, setModifiedReliabilityInitiativeCells] = useState({})
  const [remarkDialogOpenReliabilityInitiative, setRemarkDialogOpenReliabilityInitiative] = useState(false)
  const [currentRemarkReliabilityInitiative, setCurrentRemarkReliabilityInitiative] = useState('')
  const [currentRowIdReliabilityInitiative, setCurrentRowIdReliabilityInitiative] = useState(null)
  ...
  return (
    <>
      ...
      <KendoDataTables
        ...
        permissions={{ ...gridPermissions, titleName: 'Reliability Performance', ExcelName: 'Reliability_Performance' }}
      ...
      <KendoDataTables
        ...
        permissions={{ ...gridPermissions, titleName: 'Financial Aspect', ExcelName: 'Financial_Aspect' }}
      ...
      <KendoDataTables
        ...
        permissions={{ ...gridPermissions, titleName: 'Major Reliability Incidents', ExcelName: 'Major_Reliability_Incidents' }}
      ...
      <KendoDataTables
        ...
        permissions={{ ...gridPermissions, titleName: 'Reliability Improvement Initiative', ExcelName: 'Reliability_Improvement_Initiative' }}
