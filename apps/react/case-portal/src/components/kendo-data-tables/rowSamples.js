...
export const ibrGridOneRowsSample = [
  ...
  {
    id: 2,
    Furnace: 'H10 CR Month',
    MonthNameDropdown: 'N/A',
    days: '3',
    Remarks: 'dummmy',
    isEditable: true,
    isMonthAdd: 0,
