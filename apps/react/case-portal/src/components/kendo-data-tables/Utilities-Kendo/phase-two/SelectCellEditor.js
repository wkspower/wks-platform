...
export const SelectCellEditor = ({ dataItem, field, onChange, options = [], textField = 'text', valueField = 'value', placeholder = 'Select...' }) => {
  ...
  useEffect(() => {
    ...
    const handler = setTimeout(() => {
      ...
      if (localValue && typeof localValue === 'object' && localValue[valueField] !== undefined) {
