...
const PlantsProductionSummary = () => {
  ...
  //       children: [
  //         { header: 'MT', '%': 'part1VarBudgetMT', field: 'part2VarBudgetPct' },
  //       ],
  //     },
  //     {
  ...
  //     try {
  //       const res = await DataService.getPlantProductionSummary(keycloak)
  //       if (res) {
  //         setRow(res.data)
  //       } else {
  //         setRow([])
