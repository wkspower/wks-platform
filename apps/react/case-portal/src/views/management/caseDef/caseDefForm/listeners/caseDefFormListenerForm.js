...
export const CaseDefFormEventsForm = ({ open, onClose, onSubmit, hookData, stages }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm">
            <DialogTitle>{hookData ? 'Edit Listener' : 'Add New Listener'}</DialogTitle>
            <DialogContent>
                <Box sx={{ ...styles.dialogContent, paddingTop: '1rem' }}>
                    <FormControl variant="outlined" sx={styles.formControl}>
                        ...
                        >
                            <MenuItem value="TASK_COMPLETE_EVENT_TYPE">Task Complete</MenuItem>
                        </Select>
                    </FormControl>
                    ...
                    {eventType && (
                        <FormControl variant="outlined" sx={styles.formControl}>
                            ...
                            <Select
                                ...
                                sx={styles.typeSelect}
                            >
                                <MenuItem value="CASE_STAGE_UPDATE_ACTION">Progress Stage</MenuItem>
                                <MenuItem value="CASE_QUEUE_UPDATE_ACTION">Assign Queue</MenuItem>
                            </Select>
                        </FormControl>
                    )}
