...
Now that you're familiar with WKS, you're ready to dive deeper:

- [Create Your First Process Definition](./bpm-process-definition.md)  
- [Learn About Case Management](./case-definition.md)  
- [Explore Task Types](./tasks.md)  
- [Understand Integration & API Usage](./rest-api.md)
