...
![Gif showing the created case](https://wkspower.com/hs-fs/hubfs/Reviewing.gif?width=3008&height=1536&name=Reviewing.gif)
> 🛠 WKS does **not provide** out-of-the-box email consumers. You must build your own using tools like Microsoft Power Automate, Java, or Node.js, depending on your email provider.
...
- Use **Microsoft Power Automate** for reading from Microsoft 365 mailboxes
- Ensure your custom email consumer handles:
  - Message parsing
  - Case key detection
  - API authentication and retries
- Define **error handling paths** in your Camunda models for email delivery or processing failures
