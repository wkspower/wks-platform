...
| `demo` | `demo-data-loader` | One-shot loader that seeds demo cases, forms, processes, and Keycloak users, then exits |

```bash
docker compose up -d                                   # core + portal (default)
...
docker compose --profile portal --profile demo up -d   # seed demo data
