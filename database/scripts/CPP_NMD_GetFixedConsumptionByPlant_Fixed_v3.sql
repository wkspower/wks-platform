...
BEGIN
    ...
    (
        ...
        SELECT DISTINCT
            ...
            -- FIX: Always use the cost center''s plant mapping, ignore the utility''s plant mapping
            pm.CorrectedPlantName AS UtilityPlantName,
            pm.CorrectedPlantCode AS UtilityPlantCode,
            np.UOM,
        ...
        -- Remove the LEFT JOIN to Plants table entirely
    ),
    BaseData AS
    (
